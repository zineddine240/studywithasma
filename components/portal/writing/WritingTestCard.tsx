...
import { WritingTestStatus } from "@/lib/storage/writing-storage";
  ...
  return (
    <div className="bg-card rounded-2xl border border-border p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col h-full relative overflow-hidden group">
      ...
      <div className="flex justify-between items-start mb-4">
        <span className="text-xs font-bold px-2.5 py-1 rounded-md border bg-primary/10 text-primary border-primary/20">
          {test.taskType || "Writing Practice"}
        </span>
