...
export function WritingTestCard({ test, status }: WritingTestCardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-border p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col h-full relative overflow-hidden group">
