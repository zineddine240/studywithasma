    ...
    <div className="w-full max-w-[1200px] mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Link 
          ...
          className="p-2 bg-card rounded-full border border-border text-muted-foreground hover:text-foreground hover:bg-muted transition-colors"
        >
      ...
      <div className="grid lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-card rounded-2xl border border-border p-6 shadow-sm">
            ...
            {test.taskType === "General Task 1" && test.tone && (
              <div className="mt-6 p-3 bg-amber-500/10 border border-amber-500/20 text-amber-700 dark:text-amber-400 rounded-xl flex items-center gap-2">
            ...
            {test.taskType === "Task 2" && test.essayType && (
              <div className="mt-6 p-3 bg-blue-500/10 border border-blue-500/20 text-blue-700 dark:text-blue-400 rounded-xl flex items-center gap-2">
        ...
        <div className="lg:col-span-7 space-y-6 flex flex-col h-full">
          ...
          <div className="bg-card rounded-2xl border border-border shadow-sm flex flex-col overflow-hidden flex-grow relative">
            ...
            <textarea
              ...
              className="w-full h-full min-h-[400px] p-6 resize-none outline-none text-base leading-relaxed bg-transparent text-foreground disabled:bg-muted/30 disabled:text-muted-foreground custom-scrollbar"
              spellCheck={false}
            />
          ...
          {result && (
            <div className="mt-8">
              ...
              <div className="mt-8 text-center border-t border-border pt-8">
                <Link
                  href="/student-portal/writing-practice"
                  className="inline-flex items-center justify-center bg-card border-2 border-border text-foreground hover:border-primary/50 hover:bg-muted px-8 py-3 rounded-xl font-bold transition-colors"
                >
